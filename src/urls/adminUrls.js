...
const deleteService_url = (id, role) =>
    `${BACKEND_URL}delete-service/${id}/${role}`;
...
const getShifts_url = (params) =>
    `${BACKEND_URL}get-shifts?${params.toString()}`;
...
const getCoordinatorsByFacility_url = (id) =>
    `${BACKEND_URL}get-coordinators-by-facility/${id}`;
const getCoordinatorById_url = (id) =>
    `${BACKEND_URL}get-coordinator-by-id/${id}`;
...
const sendShiftNotification_url = `${BACKEND_URL}resend-shift-notification`;
